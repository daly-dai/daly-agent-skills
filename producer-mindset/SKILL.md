...
| 版本 | 日期 | 变更 |
|------|------|------|
| v3.1 | 2026-05-04 | 成本框架补全(社保雇主负担×1.26-1.40/租金年递增/税务)；新增搜索降级协议(L1-L3)；验证清单按路由拆分(通用8条+Route A 3条/B 12条/C 4条/D 3条)；Route C加强(进入壁垒Step 3.5/搜索项+2)；输出规则新增"成本算到位"；参考手册时效标注 |
